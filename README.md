...
### [CSV Model for training](https://github.com/LoaiEsam37/csv)
...
<hr>
   ...
   * Steps:
   ...
   ![](https://github.com/LoaiEsam37/Images/blob/main/dataparse(40).png)

   * Result :

   ![](https://github.com/LoaiEsam37/Images/blob/main/dataparse(41).png)
